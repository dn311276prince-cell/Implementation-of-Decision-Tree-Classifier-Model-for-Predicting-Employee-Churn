...
1. **Collect and Prepare Data**
   Gather employee data (age, salary, job role, experience, satisfaction, etc.). Clean the data and split it into training and testing sets.

2. **Build the Decision Tree Model**
   Select important features and train the Decision Tree classifier using criteria like **Gini Index** or **Entropy** to create decision rules.

3. **Train and Evaluate the Model**
   Fit the model on training data and evaluate its performance on test data using accuracy or confusion matrix.

4. **Predict Employee Churn**
   Use the trained model to predict whether an employee will **stay or leave** the organization 
...
<Figure size 2000x1000 with 1 Axes><img width="1570" height="790" alt="image" src="https://github.com/user-attachments/assets/2a9301aa-0d97-4605-b833-3cdf94a630f9" />
